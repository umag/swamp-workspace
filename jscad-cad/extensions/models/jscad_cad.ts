  ...
  upgrades: [
    {
      ...
      description:
        "B3/B4/B5 latent-bug fixes (script_evaluator.ts eval-subprocess seam); no globalArguments/schema change",
    ...
    },
    {
      ...
      description:
        "Dependency bump: @jscad/modeling 2.12.0 -> 2.13.0; @jscad/stl-serializer, " +
        "@jscad/dxf-serializer, @jscad/obj-serializer 2.1.21 -> 2.1.23; " +
        "@jscad/3mf-serializer 2.1.15 -> 2.1.17; @jscad/svg-serializer " +
        "2.3.10 -> 2.3.21; no schema change",
      upgradeAttributes: (old: Record<string, unknown>) => old,
    },
    {
