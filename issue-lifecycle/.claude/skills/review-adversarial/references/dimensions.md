...
Lightweight check only — flag obvious hardcoded secrets in the code under
review. For vault annotations, env-based auth, scoping, and deep credential
audit, defer to `/review-security`.
