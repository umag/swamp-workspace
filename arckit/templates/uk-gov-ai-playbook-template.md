...
**Critical Issues**: [Number] blocking issues **Go/No-Go Decision**: [ ]
...
**Use Case**: [Describe how the AI will be used in government operations]
...
**Principle**: Organizations must comprehend what AI is, its capabilities, and
limitations.
...
**Findings**: [Describe team's understanding of AI capabilities and limitations]

**Gaps**: [List misunderstandings or unrealistic expectations]
...
**Principle**: AI deployment must comply with legal requirements and ethical
standards.
...
- Legal basis for processing: [Consent / Legitimate Interest / Public Task /
  etc.]
- Special category data: [ ] Yes / [ ] No (if yes, justify)
- Data retention period: [X months/years]
- Right to object: [ ] Enabled / [ ] Not applicable

**Findings**: [Describe legal and ethical compliance]

**Gaps**: [List legal or ethical risks]
...
**Principle**: Systems must be secure and resilient to cyber attacks, including
AI-specific threats.
...
- [ ] AI-specific threats assessed (prompt injection, data poisoning, model
      theft)
...
**Findings**: [Describe security implementation]

**Gaps**: [List security vulnerabilities]
...
**Findings**: [Describe human oversight mechanisms]

**Gaps**: [List areas lacking sufficient human control]
...
**Principle**: Understand complete product lifecycle from selection to
decommissioning.
...
- [ ] Supplier evaluation completed (see ARC-_-EVAL-_.md)
...
**Findings**: [Describe lifecycle management approach]

**Gaps**: [List missing lifecycle processes]
...
**Principle**: AI should only be deployed when it genuinely solves problems
...
**Findings**: [Describe rationale for AI selection]

**Gaps**: [List concerns about appropriateness]
...
**Findings**: [Describe collaboration efforts]

**Gaps**: [List missed collaboration opportunities]
...
**Principle**: Early engagement with commercial colleagues on responsible AI
expectations.
...
**Findings**: [Describe commercial partnership approach]

**Gaps**: [List missing contract terms or supplier commitments]
...
**Findings**: [Describe team capabilities]

**Gaps**: [List missing skills or expertise]
...
**Principle**: AI use must align with organizational policies, governance, and
assurance.
...
**Findings**: [Describe organizational alignment]

**Gaps**: [List governance or alignment issues]
...
- [ ] **Partial explainability**: Can explain general logic, not individual
      decisions
...
**Assessed By**: [Name, Role] **Date**: [Date]

**Senior Responsible Owner**: Name: ________________ Date: ________________
Signature: ________________

**AI Governance Board Chair**: Name: ________________ Date: ________________
Signature: ________________
...
**Next Review**: [Date] **Review Frequency**:
...
**Template Version**: 1.0 **Last Updated**: 2025-10-14 **Source**:
...
**Generated by**: ArcKit `/arckit:ai-playbook` command **Generated on**: [DATE]
