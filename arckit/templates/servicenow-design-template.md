...
**Service Type**: [Application / Infrastructure / Business Service] **Service
Owner**: [Team/Department] **Service Tier**: [Tier 1 Critical / Tier 2 Important
/ Tier 3 Standard]
...
[Derive CI hierarchy from architecture diagrams - Context/Container/Component
layers map to Business Service/Application/Infrastructure CIs]
...
**Generated by**: ArcKit `/arckit:servicenow` command **Generated on**: [DATE]
