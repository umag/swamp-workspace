...
[1-2 paragraphs: What is the strategic vision? What problem are we solving? What
...
1. **Architecture Strategy** → 2. **Security Baseline** → 3. **Cloud Platform**
   → 4. **Application Modernization** → 5. **Optimization**
...
**Generated by**: ArcKit `/arckit:roadmap` command **Generated on**: [DATE]
