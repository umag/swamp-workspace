...
**Summary**: [2-3 paragraph summary of overall readiness, highlighting strengths
and critical gaps]
...
**Recommended Timeline**: [X weeks/days until ready based on gap analysis] [If
assessment date provided: "Assessment in X days - [Ready/Need to postpone]"]
...
**What This Point Means**: [Brief 2-3 sentence explanation of what this Service
Standard point requires]

**Why It Matters**: [1-2 sentences on importance]
...
✅ __ARC-{PROJECT_ID}-REQ-v_.md_* (lines XX-YY)

- [Specific evidence found]
- [What this demonstrates]

✅ __ARC-{PROJECT_ID}-STKE-v_.md_* (Section X)

- [Specific evidence found]
- [What this demonstrates]

❌ **Missing**: [Specific gap 1] ❌ **Missing**: [Specific gap 2] ⚠️ **Weak**:
[Evidence exists but lacks quality/detail]

**Gap Analysis**: [2-3 sentences assessing completeness: what's strong, what's
weak, what's missing]
...
**Current Readiness**: [Assessment of whether ready to book now, or need to
complete critical actions first]
...
**Phase-Specific Additions**: [List additional roles needed for this specific
phase]
...
**Generated by**: ArcKit `/arckit:service-assessment` command **Generated on**:
...
_Good luck with your assessment! Show your work, explain your thinking, and be
open to feedback._
