...
This document defines the criteria, scoring methodology, and process for
evaluating vendor proposals for [PROJECT_NAME]. The goal is to select the vendor
that provides the best value considering technical capability, experience, cost,
and cultural fit.
...
Before scoring, vendors must meet ALL mandatory qualifications. Failure on any
item results in disqualification.
...
4. Vendor has [48 hours] to provide clarification if failure was due to
   misunderstanding
...
**Purpose**: Evaluate the proposed technical solution's quality, feasibility,
and alignment with requirements and architecture principles.
...
**Purpose**: Evaluate the vendor's approach to delivering the project, managing
...
**Purpose**: Evaluate the vendor's team expertise, experience, and ability to
deliver.
...
**Purpose**: Evaluate vendor's track record delivering similar projects
successfully.
...
Cost proposals are opened **only for shortlisted vendors** after technical
...
2. **On-Time Delivery**: Was the project delivered on schedule? If not, what
   caused delays?
   - [ ] On time [ ] Minor delays (<10%) [ ] Significant delays (>10%)
   - Notes: _______________

3. **On-Budget Delivery**: Was the project delivered within budget? Were there
   change orders?
   - [ ] On budget [ ] Minor overruns (<10%) [ ] Significant overruns (>10%)
   - Notes: _______________

4. **Quality**: Was the quality of deliverables high? Did it meet your
   expectations?
   - [ ] Exceeded expectations [ ] Met expectations [ ] Below expectations
   - Notes: _______________

5. **Team Effectiveness**: How effective was the vendor's team? Communication?
   Responsiveness?
...
10. **Anything Else**: Is there anything else we should know about working with
    this vendor?
    - Notes: _______________
...
- [ ] Mixed (some concerns, met most expectations, might rehire with
      reservations)
...
- **Disqualification**: Multiple negative references or single highly negative
  reference
- **Score Adjustment**: Concerning patterns (e.g., always over budget) may lower
  relevant subcriteria scores by 10-20%
...
The highest scoring vendor is typically selected, but decision may also
consider:
...
**Selection Rationale**: [Summary of why this vendor was selected]
...
**Generated by**: ArcKit `/arckit:evaluate` command **Generated on**: [DATE]
