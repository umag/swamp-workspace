...
**Accreditation Status**: [Not Started / In Progress / Accredited / Conditional
Accreditation]
...
**Highest Data Classification**: [OFFICIAL / OFFICIAL-SENSITIVE / SECRET / TOP
SECRET]

**Classification Justification**: [Explain why this classification level is
required]
...
**Principle**: Multiple layers of security controls so that if one fails, others
continue to protect.

**Status**: [✅ Compliant | ⚠️ Partially Compliant | ❌ Non-Compliant]

**Evidence**: [Describe layered security controls implemented]
...
**Principle**: Systems are secure out-of-the-box with minimal configuration
required.

**Status**: [✅ Compliant | ⚠️ Partially Compliant | ❌ Non-Compliant]

**Evidence**: [Describe default security configurations]
...
**Principle**: Users and systems have only the minimum access required to
...
**Evidence**: [Describe breach detection and response capabilities]
...
**Accreditation Type**: [Full Accreditation / Interim Accreditation / Risk
...
**Information Assurance Owner (IAO)**: [Name/Role] **Information Assurance
Architect (IAA)**: [Name/Role]
...
**Risk Assessment Method**: [HMG Information Assurance Standard No. 1 & 2 / ISO
27005 / Other]
...
**Recent Penetration Test**: [Date / Not Yet Conducted] **Penetration Test
...
**Last DR Test**: [Date / Not Conducted] **DR Test Results**: [Successful /
Issues identified]
...
**Documentation Review Frequency**: [Annual / Biennial] **Last Documentation
Review**: [Date]
...
**Next Assessment Date**: [Date - recommend quarterly during development,
annually in Live]
