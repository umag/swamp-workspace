...
**Overall Residual Risk Score:** [YYY]/500 **Risk Reduction from Controls:**
[ZZ]% reduction from inherent risk **Risk Profile Status:** ✅ Acceptable | ⚠️
...
1. **R-001** (STRATEGIC, Critical 20): [Title] - Owner: [Name] - Status:
   [Status]
2. **R-002** (TECHNOLOGY, Critical 25): [Title] - Owner: [Name] - Status:
   [Status]
...
- [Finding 1: e.g., "Heavy concentration of technology risks with single owner
  (CTO)"]
...
1. [Recommendation 1: e.g., "Escalate R-001, R-002, R-005 to Steering Committee
   immediately"]
2. [Recommendation 2: e.g., "Implement automated monitoring for technology
   risks"]
3. [Recommendation 3: e.g., "Obtain Board approval for risks exceeding financial
   appetite"]
...
- **Significant Improvement**: R-001 (25→6), R-004 (20→4) - Controls very
  effective
- **Moderate Improvement**: R-002 (9→9), R-005 (16→12) - Additional controls
  needed
...
**Category:** STRATEGIC **Status:** In Progress **Risk Owner:** [Name, Role]
(from Stakeholder RACI: Accountable) **Action Owner:** [Name, Role]

#### Risk Identification

**Risk Description:** [Detailed description of the risk - 2-3 sentences
explaining what the risk is]
...
**Consequences if Realized:** [What happens if this risk occurs? Tangible
impacts:]
...
- **[Stakeholder 1]** (from ARC-{PROJECT_ID}-STKE-v*.md): [How they are
  affected]
...
**Risk Zone:** 🟧 High (13-19) **Risk Reduction:** 36% reduction from inherent
(25 → 16)
...
**Rationale:** [Why this response was chosen - e.g., "Risk exceeds appetite but
can be mitigated through additional controls at reasonable cost"]
...
**Current Residual Risk Score:** 16 (High) **Assessment:** ❌ **Exceeds
Appetite** by 4 points (33% over threshold)

**Justification:** [Why proceeding despite exceeding appetite - e.g., "Strategic
imperative from CEO driver D-001, Board approval obtained 2025-10-15"]

**Escalation Required:** Yes - Board approval required for risks exceeding
strategic appetite
...
**Category:** TECHNOLOGY **Status:** Open **Risk Owner:** [Name, Role] **Action
Owner:** [Name, Role]
...
**Total STRATEGIC Risks:** [X] **Average Inherent Score:** 14.2 (High) **Average
Residual Score:** 9.8 (Medium) **Control Effectiveness:** 31% reduction
...
**Category Risk Profile:** ⚠️ Concerning - 2 risks exceed appetite, additional
controls needed
...
**Total OPERATIONAL Risks:** [X] **Average Inherent Score:** 10.5 (Medium)
**Average Residual Score:** 6.2 (Medium) **Control Effectiveness:** 41%
reduction
...
**Category Risk Profile:** ✅ Acceptable - All risks within appetite, good
...
**Total FINANCIAL Risks:** [X] **Average Inherent Score:** 12.0 (Medium)
**Average Residual Score:** 8.5 (Medium) **Control Effectiveness:** 29%
reduction
...
**Category Risk Profile:** ✅ Acceptable - Risks within appetite, monitoring
required
...
**Total COMPLIANCE Risks:** [X] **Average Inherent Score:** 16.0 (High)
**Average Residual Score:** 11.3 (Medium) **Control Effectiveness:** 29%
reduction
...
**Category Risk Profile:** ⚠️ Concerning - Compliance risks harder to mitigate,
legal review needed
...
**Total REPUTATIONAL Risks:** [X] **Average Inherent Score:** 13.5 (High)
**Average Residual Score:** 10.0 (Medium) **Control Effectiveness:** 26%
reduction
...
**Category Risk Profile:** ⚠️ Concerning - Reputational risks difficult to
recover from, prevention critical

---

### TECHNOLOGY Risks

**Total TECHNOLOGY Risks:** [X] **Average Inherent Score:** 15.0 (High)
**Average Residual Score:** 9.3 (Medium) **Control Effectiveness:** 38%
reduction
...
**Category Risk Profile:** ✅ Acceptable - Good control effectiveness, CTO
actively managing
...
- **60% of risks require active treatment** - Significant mitigation effort
  needed
...
1. **URGENT**: Escalate R-003 (COMPLIANCE) to Audit Committee - 300% over
   appetite
2. **HIGH PRIORITY**: Obtain Board approval for R-001 (STRATEGIC) - pending
   approval
...
**Total Urgent Actions:** 2 **Total Cost:** £70K **Expected Risk Reduction:** 15
points total
...
**Total High Priority Actions:** 2 **Total Cost:** £45K **Expected Risk
Reduction:** 10 points total
...
**Total Medium Priority Actions:** 2 **Total Cost:** £15K **Expected Risk
Reduction:** 6 points total
...
- **R-001** (STRATEGIC, 16): Demonstrates need for immediate action to address
  [strategic driver]
...
_This risk register follows HM Treasury Orange Book (2023) principles and
integrates with ArcKit's stakeholder-driven architecture governance framework._

_For questions or updates, contact: [Risk Register Owner Name and Email]_
...
**Generated by**: ArcKit `/arckit:risk` command **Generated on**: [DATE]
