...
This document presents AWS-specific technology research findings for the project
requirements. It provides AWS service recommendations, architecture patterns,
and implementation guidance based on official AWS documentation.
...
**Research Sources**: [AWS Documentation, AWS Architecture Center, AWS
Well-Architected Framework, AWS Knowledge MCP]
...
3. **Spot Instances**: Use for dev/test and fault-tolerant workloads (up to 90%
   savings)
...
- **Alternative**: Implement strong controls on standard AWS for
  OFFICIAL-SENSITIVE
...
_Use `get_regional_availability` MCP tool for real-time verification_
...
**Generated by**: ArcKit `/arckit:aws-research` agent **Generated on**: [DATE]
