...
**Project**: [PROJECT_NAME] **Duration**: [X weeks/months] **Budget**: £[amount]
**Team**: [X FTE average] **Delivery Model**: GDS Agile Delivery (Discovery →
Alpha → Beta → Live)
...
**Generated by**: ArcKit `/arckit:plan` command **Generated on**: [DATE]
