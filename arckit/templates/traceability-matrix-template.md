...
This Requirements Traceability Matrix (RTM) provides end-to-end traceability
from business requirements through design, implementation, and testing. It
ensures:
...
- ⚠️ **Partial**: Requirement partially addressed; needs clarification or
  additional work
...
This ensures no "orphan" design elements or tests that don't trace to
requirements.
...
**Orphan Components**: [Components in design that don't trace to any
requirement - should they be removed?]
...
Components in design that do NOT trace back to any requirement (potential
over-engineering or missing requirements):
...
[If using tools like Jira, Azure DevOps, or specialized traceability tools,
document how to access and use them]
...
**Generated by**: ArcKit `/arckit:traceability` command **Generated on**: [DATE]
