...
**Cyber Security Standard Compliance**: [Compliant / Partially Compliant /
...
**Evidence**: [Describe security governance structure]
...
**Evidence**: [Describe risk management approach]
...
**Evidence**: [Describe asset inventory and management]
...
**Evidence**: [Describe supply chain security]
...
**Evidence**: [Describe protective security policies]
...
**Evidence**: [Describe access control implementation]
...
**Evidence**: [Describe data protection measures]
...
**Personal Data Processing**: [Yes / No] **DPIA Completed**: [Yes / No / N/A]
...
**Evidence**: [Describe system hardening and security]
...
**Evidence**: [Describe network architecture and security]
...
**Evidence**: [Describe security awareness program]
...
**Evidence**: [Describe monitoring capabilities]
...
**Evidence**: [Describe proactive threat hunting]
...
**Last Penetration Test**: [Date / Not Conducted] **Pen Test Findings**:
...
**Evidence**: [Describe incident response and recovery plans]
...
**Evidence**: [Describe continuous improvement process]
...
**Current Status**: [Not Started / In Progress / Certified Basic / Certified
Plus]

**Certification Date**: [Date / N/A] **Expiry Date**: [Date / N/A]
...
**Recovery Time Objective (RTO)**: [X hours] **Recovery Point Objective (RPO)**:
[X hours]
...
> (July 2025, Cabinet Office) mandates CAF Baseline/Enhanced profiles, GovAssure
> assurance for critical systems, and Secure by Design high-confidence profiles.
> This section tracks compliance with those mandatory requirements beyond the
> CAF assessment above.
...
> Reference:
> [NCSC GovAssure guidance](https://www.ncsc.gov.uk/collection/govassure)
...
> Per CSS clauses 4.3/4.4, departments must formally record and manage
> exceptions where full compliance cannot be achieved.
...
**Total Exceptions**: [Number] **Exceptions Under Active Improvement Plan**:
[Number]
...
> The
> [£210m Government Cyber Action Plan](https://www.gov.uk/government/publications/government-cyber-action-plan)
> (February 2026) is a cross-government investment programme across four
> pillars. This section tracks departmental and project alignment.
...
> is the cross-government protective security standard. The table below maps its
> nine principles to evidence captured elsewhere in this assessment and related
> ArcKit artefacts.
...
> establishes a career framework, Certified Cyber Professional (CCP)
> certification, and the Government Cyber Academy for building cyber security
> capability across government. This section assesses the project's alignment
> with profession requirements.
...
**Next Security Review**: [Date - recommend quarterly during development,
annually in Live]
...
**Generated by**: ArcKit `/arckit:secure` command **Generated on**: [DATE]
