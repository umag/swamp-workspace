...
[2-3 paragraphs articulating the strategic vision for this initiative. What
transformation are we enabling? What will success look like? How does this align
...
> _Synthesised from: ARC-[PROJECT_ID]-STKE-v_.md*
...
> _Synthesised from: ARC-000-PRIN-v_.md*
...
**Maturity Levels**: L1 (Initial), L2 (Repeatable), L3 (Defined), L4 (Managed),
L5 (Optimised)
...
- [Characteristic 6, e.g., "Data-driven decision making with self-service
  analytics"]
...
> _Synthesised from: ARC-[PROJECT_ID]-WARD-_.md (if available)*
...
> _Synthesised from: ARC-[PROJECT_ID]-ROAD-v_.md (if available)*
...
> _For detailed financial analysis, see: ARC-[PROJECT_ID]-SOBC-v_.md*
...
> Detailed NPV, IRR, BCR, benefits realisation, and year-by-year investment
> breakdowns are maintained in the Strategic Outline Business Case (SOBC). Run
> `/arckit:sobc` to generate or update the financial case.

---

## Strategic Risks & Mitigations

> _Synthesised from: ARC-[PROJECT_ID]-RISK-v_.md (if available)*
...
**Generated by**: ArcKit `/arckit:strategy` command **Generated on**: [DATE]
